-- Corrigir valores de status verificados (OPEN, ACTIVE, UPCOMING, COMPLETED)
...
BEGIN
  ...
  IF NOT p_admin_override THEN
    -- Accept OPEN, ACTIVE, UPCOMING (case-insensitive)
    IF UPPER(v_cohort_status) NOT IN ('OPEN', 'ACTIVE', 'UPCOMING') THEN
