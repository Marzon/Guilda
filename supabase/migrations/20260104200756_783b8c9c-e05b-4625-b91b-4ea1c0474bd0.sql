-- Fix get_subscription_info function to use correct date type comparison
-- The monthly_message_limits.reset_month is DATE type, not TEXT
-- So we need to compare dates, not strings
...
BEGIN
  ...
  -- Get messages sent this month (FIX: compare DATE with DATE, not DATE with TEXT)
