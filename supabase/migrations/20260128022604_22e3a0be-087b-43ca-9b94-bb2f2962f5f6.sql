-- Atualizar função can_enroll_in_cohort com parâmetro admin_override
...
BEGIN
  ...
  -- Skip profile checks if admin override is enabled
  ...
  -- Skip tier check if admin override is enabled
  IF NOT p_admin_override THEN
